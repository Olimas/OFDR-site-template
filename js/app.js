...
document.addEventListener('click', e => {
	...
	let its_iconMenu = target == iconMenu;
	let menuBody_is_active = menuBody.classList.contains('_active');

	if (!its_menuBody && !its_iconMenu && menuBody_is_active) {
	toggleMenu();
...
//! SLICK-SLIDER
//* education
if($('.education__body').length>0){
	$('.education__body').slick({
		autoplay: true,
		//infinite: false,
		dots: true,
		arrows: false,
